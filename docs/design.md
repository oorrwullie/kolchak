# Kolchak: Product and design notes

> This document preserves the longer product rationale and intended v0.1
> behavior. For implemented capabilities, installation, and development
